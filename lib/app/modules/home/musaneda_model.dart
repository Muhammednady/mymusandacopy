class Musaneda {
  ...
  Musaneda.fromJson(Map<String, dynamic> json) {
    currentPage = json['current_page'];
    if (json['data'] != null) {
      data = <MusanedaData>[];
      json['data'].forEach((v) {
        data?.add(MusanedaData.fromJson(v));
      });
    }
...
class MusanedaData {
  ...
  String? image;
  String? video;
  String? resume;//url of maid resume on web
  ...
  MusanedaData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
